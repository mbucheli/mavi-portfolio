        ...
        <div>
            ...
            <div className="card" style={{ width: "60vw", height: "70vh", borderRadius: "10px", marginLeft: "auto", marginRight: "auto", marginTop: "80px", backgroundColor: "#e1dee9" }}>
                ...
                <div className="card-content">
                    ...
                    <p><a href="https://61476edc82275da63e21a4c5--epic-lewin-71634e.netlify.app/" target="_blank">Live Site</a></p>
                </div>
                <div className="card-reveal" style={{ fontFamily: "Domine" }}>
                    ...
                    <p><a href="https://github.com/mbucheli/Chef-Random" target="_blank">Chef Random's Github</a></p>
                </div>
            </div>
            {/* Recipe Box */}
            <div className="card" style={{ width: "60vw", height: "70vh", borderRadius: "10px", marginLeft: "auto", marginRight: "auto", marginTop: "80px", backgroundColor: "#e1dee9" }}>
                ...
                <div className="card-content">
                    ...
                    <p><a href="https://mavi-project-2.herokuapp.com/recipes" target="_blank">Live Site</a></p>
                </div>
                <div className="card-reveal" style={{ fontFamily: "Domine" }}>
                    ...
                    <p><a href="https://github.com/mbucheli/mavi-project2" target="_blank">Recipe Box's Github</a></p>
                </div>
            </div>
            {/* Happy Tail */}
            <div className="card" style={{ width: "60vw", height: "70vh", borderRadius: "10px", marginLeft: "auto", marginRight: "auto", marginTop: "80px", backgroundColor: "#e1dee9" }}>
                ...
                <div className="card-content">
                    ...
                    <p><a href="https://goofy-goldwasser-3e86bc.netlify.app/" target="_blank">Live Site</a></p>
                </div>
                <div className="card-reveal" style={{ fontFamily: "Domine" }}>
